<template>
    <div id="particles" ref="particlesContainer"
        class="h-screen bg-dark flex items-center justify-center w-full overflow-hidden px-6">

        <div class="w-full absolute top-50 rounded-md bg-white p-6 shadow-md" :class="isRegister ? 'max-w-4xl' : 'max-w-sm '">
            <slot />
        </div>
